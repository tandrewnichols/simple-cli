...
class Builder {
  ...
  getReadlineValues(keys, context, msg, cb) {
    let logVals = this.standalone || this.config.cmd === false ? [this.cmd] : [ this.cmd, this.target ];
    console.log();
  ...
  debug() {
    ...
    let args = this.standalone || this.config.cmd === false ? [this.cmd] : [ this.cmd, this.target ];
  ...
  spawn() {
    ...
    let args = this.standalone || this.config.cmd === false ? [] : [this.target];
