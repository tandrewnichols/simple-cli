...
var Builder = module.exports = function Builder (cmd, done, context, grunt, customOpts) {
  // Save off all the things
  this.cmd = cmd;
  this.done = done || context.async();
  ...
  this.debug = grunt.option('debug') || this.config.debug;
  this.context = context;
  this.grunt = grunt;
  this.customOptions = customOpts;
